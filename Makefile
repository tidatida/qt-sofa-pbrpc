#############################################################################
# Makefile for building: echo
# Generated by qmake (3.0) (Qt 5.7.0)
# Project:  echo.pro
# Template: app
# Command: /usr/bin/qmake -o Makefile echo.pro
#############################################################################
...
INCPATH       = -I. -I/output/include -I/opt/Qt5.7.0/5.7/gcc_64/include -I/opt/Qt5.7.0/5.7/gcc_64/include/QtCore -I. -I/opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++
QMAKE         = /usr/bin/qmake
DEL_FILE      = rm -f
...
COMPRESS      = gzip -9f
DISTNAME      = echo1.0.0
DISTDIR = /echo/.tmp/echo1.0.0
LINK          = g++
LFLAGS        = -Wl,-O1 -Wl,-rpath,/opt/Qt5.7.0/5.7/gcc_64/lib
LIBS          = $(SUBLIBS) -L/output/lib -lsofa-pbrpc -lprotobuf -lprotoc -lsnappy -lz -lm -lc -L/opt/Qt5.7.0/5.7/gcc_64/lib -lQt5Core -lpthread 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
Makefile: echo.pro /opt/Qt5.7.0/5.7/gcc_64/mkspecs/linux-g++/qmake.conf /opt/Qt5.7.0/5.7/gcc_64/mkspecs/features/spec_pre.prf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/unix.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/linux.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/sanitize.conf \
		/opt/Qt5.7.0/5.7/gcc_64/mkspecs/common/gcc-base.conf \
...
distdir: FORCE
	...
	$(COPY_FILE) --parents echo_service.pb.h b.h $(DISTDIR)/
	$(COPY_FILE) --parents main.cpp b.cpp echo_service.pb.cc $(DISTDIR)/
...
main.o: main.cpp /opt/Qt5.7.0/5.7/gcc_64/include/QtCore/QCoreApplication \
		...
		b.h \
		/output/include/sofa/pbrpc/pbrpc.h \
		/output/include/sofa/pbrpc/common.h \
		/output/include/sofa/pbrpc/smart_ptr/smart_ptr.hpp \
		/output/include/sofa/pbrpc/smart_ptr/scoped_ptr.hpp \
		/output/include/sofa/pbrpc/smart_ptr/checked_delete.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/operator_bool.hpp \
		/output/include/sofa/pbrpc/smart_ptr/scoped_array.hpp \
		/output/include/sofa/pbrpc/smart_ptr/weak_ptr.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/shared_count.hpp \
		/output/include/sofa/pbrpc/smart_ptr/bad_weak_ptr.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/sp_counted_base.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/sp_counted_base_gcc_x86.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/sp_counted_impl.hpp \
		/output/include/sofa/pbrpc/smart_ptr/shared_ptr.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/sp_convertible.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/spinlock_pool.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/spinlock.hpp \
		/output/include/sofa/pbrpc/smart_ptr/detail/spinlock_pt.hpp \
		/output/include/sofa/pbrpc/smart_ptr/memory_order.hpp \
		/output/include/sofa/pbrpc/smart_ptr/enable_shared_from_this.hpp \
		/output/include/sofa/pbrpc/smart_ptr/owner_less.hpp \
		/output/include/sofa/pbrpc/rpc_error_code.h \
		/output/include/sofa/pbrpc/rpc_controller.h \
		/output/include/sofa/pbrpc/rpc_option.pb.h \
		/output/include/sofa/pbrpc/rpc_channel.h \
		/output/include/sofa/pbrpc/rpc_client.h \
		/output/include/sofa/pbrpc/rpc_server.h \
		/output/include/sofa/pbrpc/ext_closure.h \
		/output/include/sofa/pbrpc/closure_helper.h \
		/output/include/sofa/pbrpc/profiling_linker.h \
		/output/include/sofa/pbrpc/atomic.h \
		/output/include/sofa/pbrpc/counter.h \
		/output/include/sofa/pbrpc/closure.h \
		/output/include/sofa/pbrpc/http.h \
		/output/include/sofa/pbrpc/buffer.h \
		/output/include/sofa/pbrpc/buf_handle.h \
		/output/include/sofa/pbrpc/locks.h \
		/output/include/sofa/pbrpc/spin_lock.h \
		/output/include/sofa/pbrpc/mutex_lock.h \
		/output/include/sofa/pbrpc/rw_lock.h \
		/output/include/sofa/pbrpc/fast_lock.h \
		/output/include/sofa/pbrpc/scoped_locker.h \
		/output/include/sofa/pbrpc/condition_variable.h \
		/output/include/sofa/pbrpc/string_utils.h \
		/output/include/sofa/pbrpc/thread_group.h \
		/output/include/sofa/pbrpc/timeout_manager.h \
		/output/include/sofa/pbrpc/wait_event.h \
		echo_service.pb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o main.o main.cpp

b.o: b.cpp /output/include/sofa/pbrpc/pbrpc.h \
		/output/include/sofa/pbrpc/common.h \
		/output/include/sofa/pbrpc/smart_ptr/smart_ptr.hpp \
		/output/include/sofa/pbrpc/smart_ptr/scoped_ptr.hpp \
		/output/include/sofa/pbrpc/smart_ptr/checked_delete.hpp \
		...
		/output/include/sofa/pbrpc/wait_event.h \
		echo_service.pb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o b.o b.cpp

echo_service.pb.o: echo_service.pb.cc echo_service.pb.h
	$(CXX) -c $(CXXFLAGS) $(INCPATH) -o echo_service.pb.o echo_service.pb.cc
